...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [question setText:[item itemName]];
    [answer setText:[item descript]];
    ...
    if(!typeLabel)
        typeLabel = @"None";
    [explanation setTitle:[NSString stringWithFormat:@"Type: %@", typeLabel]
...
- (void)viewWillDisappear:(BOOL)animated
{
    ...
    [item setItemName:[question text]];
    [item setDescript:[answer text]];
}
