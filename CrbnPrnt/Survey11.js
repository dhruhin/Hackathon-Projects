/*
 * JS for Survey11 generated by Tiggzi
 *
...
j_94_js = function(runBeforeShow) { /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'mobilebutton23': 'j_97',
        'mobilelabel3': 'j_99',
        'mobileradiogroup5': 'j_100',
        'mobileradiobutton14': 'j_101',
        'mobileradiobutton26': 'j_102',
        'mobilelabel4': 'j_103',
        'miles': 'j_104',
        'mobilelabel5': 'j_105',
        'mobileradiogroup16': 'j_106',
        'mobileradiobutton41': 'j_107',
        'mobileradiobutton42': 'j_108',
        'mobileradiobutton43': 'j_109',
        'mobilelabel7': 'j_110',
        'tv': 'j_111',
        'mobilelabel35': 'j_112',
        'mobileradiogroup20': 'j_113',
        'mobileradiobutton48': 'j_114',
        'mobileradiobutton49': 'j_115',
        'mobilelabel38': 'j_116',
        'mobileradiogroup18': 'j_117',
        'mobileradiobutton48': 'j_118',
        'mobileradiobutton49': 'j_119',
        'mobilebutton20': 'j_120',
        'mobilenavbar5': 'j_122',
        'mobilenavbaritem13': 'j_123',
        'resultsbutton': 'j_124',
        'historybutton': 'j_125'
    };
    ...
    postsurvey = new Tiggr.DataSource(StackMobSurveyPost, {
        'onComplete': function(jqXHR, textStatus) {
            $t.refreshScreenFormElements("j_94");
        },
    ...
    // screen onload
    screen_2B7A_onLoad = j_94_onLoad = function() {
        screen_2B7A_elementsExtraJS();
        localStorage["firstname"] = "First";
        localStorage["lastname"] = "Last";
        j_94_windowEvents();
        screen_2B7A_elementsEvents();
    }
    // screen window events
    screen_2B7A_windowEvents = j_94_windowEvents = function() {
        $('#j_94').bind('pageshow orientationchange', function() {
            adjustContentHeightWithPadding();
        });
    }
    // screen elements extra js
    screen_2B7A_elementsExtraJS = j_94_elementsExtraJS = function() {
        // screen (screen-2B7A) extra code
    }
    // screen elements handler
    screen_2B7A_elementsEvents = j_94_elementsEvents = function() {
        $("a :input,a a,a fieldset label").live({
            click: function(event) {
                event.stopPropagation();
            }
        });
        $('#j_96 [name="mobilebutton23"]').die().live({
            click: function() {
        ...
        $('#j_98 [name="mobilebutton20"]').die().live({
            click: function() {
                if (!$(this).attr('disabled')) {
                    try {
                        postsurvey.execute({})
        ...
        $('#j_121 [name="resultsbutton"]').die().live({
            click: function() {
                if (!$(this).attr('disabled')) {
                    Tiggr.navigateTo('Results', {
                        reverse: false
        ...
        $('#j_121 [name="historybutton"]').die().live({
            click: function() {
                if (!$(this).attr('disabled')) {
