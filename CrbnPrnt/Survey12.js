/*
 * JS for Survey12 generated by Tiggzi
 *
...
j_25_js = function(runBeforeShow) { /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'mobilebutton23': 'j_28',
        'mobilelabel3': 'j_30',
        'mobileradiogroup5': 'j_31',
        'mobileradiobutton14': 'j_32',
        'mobileradiobutton26': 'j_33',
        'mobilelabel4': 'j_34',
        'miles': 'j_35',
        'mobilelabel5': 'j_36',
        'mobileradiogroup16': 'j_37',
        'mobileradiobutton41': 'j_38',
        'mobileradiobutton42': 'j_39',
        'mobileradiobutton43': 'j_40',
        'mobilelabel7': 'j_41',
        'tv': 'j_42',
        'mobilelabel35': 'j_43',
        'mobileradiogroup20': 'j_44',
        'mobileradiobutton48': 'j_45',
        'mobileradiobutton49': 'j_46',
        'mobilelabel38': 'j_47',
        'mobileradiogroup18': 'j_48',
        'mobileradiobutton48': 'j_49',
        'mobileradiobutton49': 'j_50',
        'mobilebutton20': 'j_51',
        'mobilenavbar5': 'j_53',
        'mobilenavbaritem13': 'j_54',
        'resultsbutton': 'j_55',
        'historybutton': 'j_56'
    };
    ...
    // screen onload
    screen_1CEB_onLoad = j_25_onLoad = function() {
        screen_1CEB_elementsExtraJS();
        localStorage["firstname"] = "First";
        localStorage["lastname"] = "Last";
        j_25_windowEvents();
        screen_1CEB_elementsEvents();
    }
    // screen window events
    screen_1CEB_windowEvents = j_25_windowEvents = function() {
        $('#j_25').bind('pageshow orientationchange', function() {
            adjustContentHeightWithPadding();
        });
    }
    // screen elements extra js
    screen_1CEB_elementsExtraJS = j_25_elementsExtraJS = function() {
        // screen (screen-1CEB) extra code
    }
    // screen elements handler
    screen_1CEB_elementsEvents = j_25_elementsEvents = function() {
        $("a :input,a a,a fieldset label").live({
            click: function(event) {
                event.stopPropagation();
            }
        });
        $('#j_27 [name="mobilebutton23"]').die().live({
            click: function() {
        ...
        $('#j_29 [name="mobilebutton20"]').die().live({
            click: function() {
                if (!$(this).attr('disabled')) {
                    try {
                        postsurvey.execute({})
        ...
        $('#j_52 [name="resultsbutton"]').die().live({
            click: function() {
                if (!$(this).attr('disabled')) {
                    Tiggr.navigateTo('Results', {
                        reverse: false
        ...
        $('#j_52 [name="historybutton"]').die().live({
            click: function() {
                if (!$(this).attr('disabled')) {
